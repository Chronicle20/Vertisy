...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (cm.getPlayer().getProgressValue("marriage") == "mom&dad") {
            if (status == 0) {
                ...
                cm.getPlayer().setProgressValue("marriage", "mom&dad-2");
                cm.sendNext("Okay then. Go back to town and collect two more #bProof of Loves#k to prove it.");
                cm.dispose();
            }
        } else if (cm.getPlayer().getProgressValue("marriage") == "mom&dad-2") {
            if (status == 0) {
                ...
                cm.getPlayer().setProgressValue("marriage", "blessed");
