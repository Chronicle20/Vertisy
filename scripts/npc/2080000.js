...
function start() {
    ...
    var options = new Array("What's a stimulator?","Create a Warrior weapon","Create a Bowman weapon","Create a Magician weapon","Create a Thief weapon","Create a Pirate Weapon",
        ...
        "I want to make a Cornian's Dagger.");
...
function action(mode, type, selection) {
    ...
    if (status == 1) {
        ...
        action(mode, type, selection); // Run again with increased status.
        return;
      }
    } else if (status == 2) {
      ...
      item = 4001078;
      mats = new Array(4001079, 4011001, 4011002);
      matQty = new Array(1, 1, 1);
      cost = 10000;
    }
