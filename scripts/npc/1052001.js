...
function start() {
    ...
    } else if (actionx["3thJobI"] || (cm.getPlayer().gotPartyQuestItem("JB3") && cm.getLevel() >= 70 && (cm.getJobId() % 10 == 0 || cm.getJobId() == 432) && parseInt(cm.getJobId() / 100) == 4 && !cm.getPlayer().gotPartyQuestItem("JBP"))){
        ...
        if (status == 0)
            ...
            if (cm.canHold(2070000) && cm.canHold(1472061)){
                if (cm.getJobId() == 0){
                    ...
                    cm.getPlayer().updateQuestInfo(2351, "1");
                    cm.resetStats();
                    cm.gainSP(1);
                }
        ...
        if (status == 0){
            ...
            if (!cm.haveItem(4031012)){
                if (cm.canHold(4031011)){
                    ...
                    cm.sendSay("Please get this letter to #b#p1072003##k who's around #b#m102040000##k near Kerning City. He is taking care of the job of an instructor in place of me. Give him the letter and he'll test you in place of me. Best of luck to you.", false, false);
				} else {
