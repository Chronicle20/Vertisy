...
function action(mode, type, selection) { 
    ...
    if (status == 0) { 
		...
		if (selection == 0) { 
			cm.sendSimple("In order to make the job advancement, you must visit #rDark Lord#k at the #rFusion Jazz Bar#k in #bKerning City#k.Would you like to be transported there now? The transportation service cannot be used once you make the job advancement-\r\n\r\n#b#L0#Yes#l\r\n#L1#No#l#k"); 
		} else if (selection == 1) { 
