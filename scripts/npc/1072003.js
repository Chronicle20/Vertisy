...
function start() {
    if (cm.isQuestCompleted(100010)) {
        ...
        cm.dispose();
    } else if (cm.isQuestStarted(100010) || cm.isQuestStarted(100009) || cm.haveItem(4031011)) {
...
function action(mode, type, selection) {
    if (mode == -1)
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0 && (cm.isQuestStarted(100010) || cm.isQuestStarted(100009) || cm.haveItem(4031011)))
            status = 3;
        if (status == 1)
            ...
            cm.sendSay("You will have to collect me #b30 #t4031013##k. Good luck.", false, true);
        } else if (status == 4) {
