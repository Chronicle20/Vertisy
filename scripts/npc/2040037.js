...
function action(mode, type, selection) {
    if (mode < 1)
        ...
        if (status === 0) {
            ...
            if (preamble === null) {
                cm.sendNext("Hi. Welcome to the " + nthtext + " stage. You need to collect 15 #b#t4001022#'s#k.");
                ...
                if (!isLeader()) {
                    ...
                    if (gaveItems === null) {
                        if (cm.getPlayer().getMap().getCharacters().size() !== eim.getPlayers().size()) {
                            ...
                            cm.sendOk("Sorry, you have not collected all 15 #b#t4001022#'s#k.");
                            cm.dispose();
                        }
                    } else {
                        cm.sendOk("Hurry, go to the next stage, the portal is open!");
            ...
            cm.givePartyQuestExp("LudiPQ2nd");
