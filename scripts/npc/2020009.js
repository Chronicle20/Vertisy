...
*/
/**
 *	@Name: Robeira (Magician 3rd Job Instructor)
...
function action(mode, type, selection){
	...
	if (actionx["Mental"]){
	    if (status == 0)
			...
			cm.sendYesNo("Okay! Now, you'll be transformed into a much more powerful magician through me. Before doing that, though, please make sure your SP has been thoroughly used, You'll need to use up at least all of SP's gained until level 70 to make the 3rd job advancement. Oh, and since you have already chosen your path of the occupation by the 2nd job adv., you won't have to choose again for the 3rd job adv. Do you want to do it right now?");
		else if (status == 2) {
			...
			if (cm.getJobId() == 211) {
				cm.sendNext("You're the #bMage of Fire and Poison#k from here on out. The new skill book features new and improved fire and poison based spells, and skills such as #bElement Amplification#k (improves element-based spells) and #bSpell Boster#k (improves the overall speed of your attacking spells) will enable you to attack the monsters quickly and effectively. Defensive spells such as #bPartial Resistance#k (allows you to become stronger against certain element-based attacks) and #bSeal#k (seals up the monster) will help negate the one weakness Mages possess: lack of HP.");
