...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (qm.getPlayer().getJob().getId() == 2000) {
            ...
            //qm.getPlayer().changeSkillLevel(Packages.client.SkillFactory.getSkill(20009000), 0, -1);
            //qm.getPlayer().changeSkillLevel(Packages.client.SkillFactory.getSkill(20009000), 1, 0);
