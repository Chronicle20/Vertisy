...
function start(mode, type, selection) {
	...
	//THIS IS THE LEVEL 80 QUEST TEXT
	if (mode == 1)
		status++;
	else
		status--;
	if(status == 0){
		...
		qm.sendSay("Anyway, master, could you take a look at this?\r\n #i4032503:#\r\nThis is one of the scales I shed. For some reason, this one's still shiny. All the others sort of fell apart. I feel like this scale still carries my strength in it. Do you think we could use it for something?", true, true);
	}else if(status == 9){
