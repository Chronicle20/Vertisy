...
function init() {
	...
	startMap = em.getChannelServer().getMap(103040410);
	otherMap = em.getChannelServer().getMap(103040420);
}

function setup() {
    var eim = em.newInstance("RockSpirit_" + em.getProperty("player"), false);
    respawn(eim);
