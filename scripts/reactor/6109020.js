...
function act() {
	...
	if (em != null && !em.getProperty("glpq4pirate").equals("1")) {
		...
		rm.getPlayer().dropMessage(5, "The Pirate Sigil has already been activated.");
	}
}