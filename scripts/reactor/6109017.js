...
function act() {
	...
	if (em != null && !em.getProperty("glpq4archer").equals("1")) {
		...
		rm.getPlayer().dropMessage(5, "The Archer Sigil has already been activated.");
	}
}