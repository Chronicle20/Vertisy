...
function act() {
	...
	if (em != null && !em.getProperty("glpq4mage").equals("1")) {
		...
		rm.getPlayer().dropMessage(5, "The Mage Sigil has already been activated.");
	}
}