...
public class MapScriptMethods extends AbstractPlayerInteraction{
	...
	public void displayAranIntro(){
		switch (c.getPlayer().getMapId()){
			case 914090010:
				lockUI();
				c.announce(UserLocal.UserEffect.showIntro("Effect/Direction1.img/aranTutorial/Scene0"));
				break;
			case 914090011:
				c.announce(UserLocal.UserEffect.showIntro("Effect/Direction1.img/aranTutorial/Scene1" + c.getPlayer().getGender()));
				break;
			case 914090012:
				c.announce(UserLocal.UserEffect.showIntro("Effect/Direction1.img/aranTutorial/Scene2" + c.getPlayer().getGender()));
				break;
			case 914090013:
				c.announce(UserLocal.UserEffect.showIntro("Effect/Direction1.img/aranTutorial/Scene3"));
				break;
			case 914090100:
				lockUI();
				c.announce(UserLocal.UserEffect.showIntro("Effect/Direction1.img/aranTutorial/HandedPoleArm" + c.getPlayer().getGender()));
				break;
		}
	}
	...
	public void startExplorerExperience(){
		...
		{
			c.announce(UserLocal.UserEffect.showIntro("Effect/Direction3.img/swordman/Scene" + c.getPlayer().getGender()));
		}else if(c.getPlayer().getMapId() == 1020200) // Magician
		{
			c.announce(UserLocal.UserEffect.showIntro("Effect/Direction3.img/magician/Scene" + c.getPlayer().getGender()));
		}else if(c.getPlayer().getMapId() == 1020300) // Archer
		{
			c.announce(UserLocal.UserEffect.showIntro("Effect/Direction3.img/archer/Scene" + c.getPlayer().getGender()));
		}else if(c.getPlayer().getMapId() == 1020400) // Rogue
		{
			c.announce(UserLocal.UserEffect.showIntro("Effect/Direction3.img/rogue/Scene" + c.getPlayer().getGender()));
		}else if(c.getPlayer().getMapId() == 1020500) // Pirate
		{
			c.announce(UserLocal.UserEffect.showIntro("Effect/Direction3.img/pirate/Scene" + c.getPlayer().getGender()));
		}
	}

	public void goAdventure(){
		lockUI();
		c.announce(UserLocal.UserEffect.showIntro("Effect/Direction3.img/goAdventure/Scene" + c.getPlayer().getGender()));
	}

	public void goLith(){
		lockUI();
		c.announce(UserLocal.UserEffect.showIntro("Effect/Direction3.img/goLith/Scene" + c.getPlayer().getGender()));
	}
	...
	public void explorerQuest(short questid, String questName){
		...
		getPlayer().announce(CWvsContext.OnMessage.updateQuest(q, q.getQuest().startQuestData.infoNumber));
