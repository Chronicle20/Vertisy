...
public final class PacketProcessor{
	...
	public void reset(int channel){
		...
		if(channel < 0){// login
			...
			registerHandler(RecvOpcode.CANCEL_INVITE_PARTY_MATCH, new PartyInviteMatchCancelHandler());
			registerHandler(RecvOpcode.USER_CALC_DAMAGE_STAT_SET_REQUEST, new UserCalcDamageStatSetRequestHandler());
			registerHandler(RecvOpcode.OPEN_FAMILY, new FamilyOpenHandler());
			...
			registerHandler(RecvOpcode.ADMIN_SHOP_REQUEST, new AdminShopRequestHandler());
			registerHandler(RecvOpcode.UserFollowCharacterRequest, new FollowCharacterRequest());
			registerHandler(RecvOpcode.SetPassenserResult, new SetPassengerResultHandler());
			registerHandler(RecvOpcode.ItemReleaseRequest, new ItemReleaseRequestHandler());
			registerHandler(RecvOpcode.HyperUpgradeItemUse, new HyperUpgradeItemUseHandler());
			registerHandler(RecvOpcode.ItemOptionUpgradeItemUse, new ItemOptionUpgradeItemUseHandler());
