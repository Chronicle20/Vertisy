...
public class InfoAction extends MapleQuestAction{
	...
	public InfoAction(MapleQuest quest, LittleEndianAccessor lea){
		super(MapleQuestActionType.INFO, quest);
		processData(lea);
	}
	...
	public void processData(MapleData data){
		infoValue = MapleDataTool.getString(data);
	}

	@Override
	public void processData(LittleEndianAccessor lea){
		infoValue = lea.readMapleAsciiString();
	}

	@Override
	public void writeData(LittleEndianWriter lew){
		lew.writeMapleAsciiString(infoValue);
	}

	@Override
	public void run(MapleCharacter chr, Integer extSelection){
		// Ignore run, the code for this is in forceStart.
	}
